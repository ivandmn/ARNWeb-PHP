...
<html>
    ...
    <body>
        ...
        <?php
            $RNASequence = ""; $proteinSequence = ""; $enterRNA = ""; $validRNA = ""; $RNAError = true;
            ...
            if($RNAError == false){
                 ...
                 $proteinSequence = $objectRNASequence->translation();
                 echo '<style>#fieldsetAminoOutput { display:block;}</style>';
            }
            else{
                echo '<style>#fieldsetAminoOutput { display:none;}</style>';   
            }
        ?>
        <form method='POST' action="<?php echo \htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                <fieldset id="fieldsetRNA">
                    <legend>RNA to AminoAcids</legend>
                    <div id="RNAInput">
                ...
                <fieldset id="fieldsetAminoOutput">
                    <legend> Result </legend>
                    <textarea disabled rows="8" cols="160" class = "AminoElements"><?php echo $proteinSequence?></textarea>
                </fieldset>
        </form>
    </body>
</html>